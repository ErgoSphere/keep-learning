<template>
  <div class="loading-mask column items-center justify-center">
    <div class="loading-wrapper column items-center justify-center">
      <svg
      ...
      <div class="loading-text cs-mt-lg" v-if="text" >{{ text }}</div>
    </div>
  </div>
</template>
